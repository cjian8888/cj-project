...
# ╠══════════════════════════════════════════════════════════════════════════════╣
# ║                                                                              ║
# ║  ⚠️  本文件 (main.py) 已废弃！请勿使用！                                     ║
# ║                                                                              ║
# ║  请使用 api_server.py 作为唯一程序入口：                                     ║
# ║      python api_server.py                                                    ║
# ║                                                                              ║
# ║  所有分析功能已完全整合到 api_server.py 中。                                 ║
# ║  保留本文件仅供参考历史代码，未来版本将删除。                                 ║
# ║                                                                              ║
# ╚══════════════════════════════════════════════════════════════════════════════╝

[DEPRECATED] 主程序 - 资金穿透与关联排查系统

此文件已废弃，功能已迁移至 api_server.py。
请运行: python api_server.py
"""
