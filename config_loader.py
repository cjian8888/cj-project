...
def get_default_config() -> Dict[str, Any]:
    ...
    return {
        ...
        'time_series': {
            ...
            'sudden_change_min_amount': 100000
        },
...
if __name__ == '__main__':
    ...
    print(f'  - 数据质量优秀阈值: {config["data_quality"]["quality_levels"]["excellent"]}分')
