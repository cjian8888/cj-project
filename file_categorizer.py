...
def parse_filename_info(filename: str) -> Dict:
    ...
    文件名格式示例:
    - 标准格式: 陈斌_340825200107190410_国监查【2025】第030696号_中国工商银行交易流水.xlsx
    - 标准格式: 贵州锐晶科技有限公司_91520303MAAK4M2U3H_国监查【2025】第030696号_中国银行交易流水.xlsx
    - 简单格式: 流水_张伟.xlsx
    - 简单格式: 张伟.xlsx
    ...
    if len(parts) >= 2:
        ...
        # 身份证号: 15位纯数字 或 18位(17位数字+1位校验码，校验码可能是X)
        # 身份证号前两位是省份代码：11-65（除20、26、29、30、34、38-40、54）有效
        # 统一社会信用代码: 18位，以91/92/93等开头，包含大写字母和数字
        ...
        valid_province_codes = [
            ...
            '21', '22', '23',              # 辽宁、吉林、黑龙江
            '31', '32', '33', '35', '36', '37',  # 上海、江苏、浙江、福建、江西、山东
            '41', '42', '43', '44', '45', '46',  # 河南、湖北、湖南、广东、广西、海南
            '50', '51', '52', '53',        # 重庆、四川、贵州、云南
        ...
        def is_valid_uscc(code):
            ...
            uscc_dept_codes = ['11', '12', '13', '91', '92', '93', 'A1', 'N1', 'N2', 'N3', 'Y1']
        ...
        if is_valid_id_card(second_part):
            ...
            company_keywords = ['公司', '有限', '集团', '企业', '科技', '投资', '贸易', '实业']
...
def categorize_files(directory: str) -> Dict[str, List[str]]:
    ...
    for root, dirs, files in os.walk(directory):
        # 排除输出目录
        if 'output' in root.split(os.sep) or 'cleaned_data' in root.split(os.sep) or 'analysis_results' in root.split(os.sep):
            continue
